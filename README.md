# WP Open Vue 
WP Vue > WP Open Vue: test repository for building a custom wordpress template based on WP Vue by Alex MacArthur.

Please for the main and original project "WP Vue" follow the link (https://github.com/alexmacarthur/wp-vue).
